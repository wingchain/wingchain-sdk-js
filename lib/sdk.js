...
var Chain = /** @class */ (function (_super) {
    ...
    Chain.prototype.getProofByNumber = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.call.apply(this, __spreadArrays(['getProofByNumber'], params))];
            });
        });
    };
    Chain.prototype.getProofByHash = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.call.apply(this, __spreadArrays(['getProofByHash'], params))];
            });
        });
    };
...
var TxPool = /** @class */ (function (_super) {
    __extends(TxPool, _super);
    function TxPool() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TxPool.prototype.getTransaction = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.call.apply(this, __spreadArrays(['getTransaction'], params))];
                    case 1:
                        tx = _a.sent();
                        if (!(tx && tx.call)) {
                            return [2 /*return*/, tx];
...
var Consensus = /** @class */ (function (_super) {
    ...
    Consensus.prototype.getState = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
